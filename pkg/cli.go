...
// CliCmd handles cli commands and subcommands
type CliCmd struct {
	ExecutedAs string
	Name       string
	Args       []string
...
// AddSubCmd ...
func (cmd CliCmd) AddSubCmd(subcmd CliCmd) {
...
func (cmd CliCmd) Init(args []string) error {
	if cmd.Opts == nil {
		return nil
	}
...
func (cmd CliCmd) SubCmd(subcmdname string) (*CliCmd, bool) {
...
// Flag flag value by name
// func (cmd CliCmd) Flag(key string) string {
// 	return cmd.Flags[key].String()
// }
